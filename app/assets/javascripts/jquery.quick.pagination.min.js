 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : "<-- 1",//(new Image()).src="./images/first.gif",  
			prevArrow : "Previous",//(new Image()).src="./images/prev.gif",
			lastArrow : "Last -->",//(new Image()).src="./images/last.gif",
			nextArrow : "Next",//(new Image()).src="./images/next.gif",
			rowsPerPage : 5,
			currPage : 1,
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<span id='tablePagination_paginater' style='width:800px; margin:0 auto; text-align:center;'>");
        htmlBuffer.push("<label id='tablePagination_firstPage' style='float:left; clear:none; display:block; padding: 2px 1em 0 0;'>"+defaults.firstArrow+"</label>");
        htmlBuffer.push("<label id='tablePagination_prevPage' style='float:left; clear:none; display:block; padding: 2px 1em 0 0;'>"+defaults.prevArrow+"</label>");
        ...
        htmlBuffer.push("<label id='tablePagination_nextPage' style='float:left; clear:none; display:block; padding: 2px 1em 0 0;'>"+defaults.nextArrow+"</label>");
        htmlBuffer.push("<label id='tablePagination_lastPage' style='float:left; clear:none; display:block; padding: 2px 1em 0 0;'>"+defaults.lastArrow+"</label>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("</div>");
